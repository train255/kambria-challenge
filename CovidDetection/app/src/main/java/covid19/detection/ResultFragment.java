...
public class ResultFragment extends DialogFragment {
    ...
    private ActionProcessButton btnUpload;
...
//                        Toast.makeText(getActivity().getApplicationContext(), serverResponse.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        cancelBtn = (Button) v.findViewById(R.id.cancelDialog);
        ...
        btnUpload = (ActionProcessButton) v.findViewById(R.id.btnUpload);
        btnUpload.setMode(ActionProcessButton.Mode.ENDLESS);
